"""JPY trend-following research — run from trend/ root.
Loads USDJPY=X, runs Donchian 20 baseline + TD Sequential Breakout,
...
from scripts.bt.strategies import DonchianBreakout, TDSequentialBreakout
...
for sname, strat in [('Donchian20', DonchianBreakout(period=20)),
                     ('TD_Seq_Breakout', TDSequentialBreakout())]:
    print(f"\n=== {sname} ===")
...
print("\nAll JPY reports saved to JPY/reports/ and JPY/charts/")
