...
- **User profile:** ~49 years old, futures trader, experienced a blow-up and fully recovered over ~5 years (~2015). Post-recovery style: conservative, BUY-only, buys only when price crosses above 200-day MA. Has strong intuitive regime/market sense (reads secular patterns like Japan's post-bubble W) but struggles to formalize. Reads Market Wizards and identifies with structural-shift traders. Uneasy about pace of recent gains despite thesis having more room. The quant framework should confirm and scale his existing sense, never imply he lacks skill or experience. His "BUY above MA200" is his formalized instinct — build on it.
- **2026 results (partial):** ~40K SGD → ~50K SGD (+~23%). Major win: shorted Gold at USD 5040 (8 contracts), covered at USD 4130 (~9K SGD profit) — triggered by parabolic price pattern recognized from A50, Dot-com, GFC history. First significant short. Small loss: re-entered Gold below USD 4200 (below 200-DMA, "felt low"), tight stop, ~USD 2K loss — MA200 discipline limited damage. Parabolic-short instinct is a new formalization candidate: same pattern recognition as his buy thesis, but needs explicit size/stop/exit rules to be repeatable rather than heroic.
